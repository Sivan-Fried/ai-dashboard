...
with main_col:
    if st.session_state.current_page == "project":
        ...
        st.markdown(f'<div style="font-size:1.8rem; font-weight:800; color:#3f3f46; font-family:Plus Jakarta Sans, sans-serif; text-align:center; margin-bottom:16px; -webkit-text-fill-color:#3f3f46;">{p_name}</div>', unsafe_allow_html=True)
