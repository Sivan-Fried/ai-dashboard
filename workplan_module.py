...
.controls {{ display: flex; justify-content: flex-end; padding: 12px 20px 10px; direction: rtl; margin-bottom: 36px; }}
...
.dt {{ font-size: 13px; font-weight: 600; color: #1e293b; margin: 2px 0; }}
.st {{ font-size: 10px; font-weight: 700; display: block; color: #94a3b8; margin-top: 1px; }}
.live {{ color: #10b981; }}
.wip  {{ color: #f59e0b; }}
