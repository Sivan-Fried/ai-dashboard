...
<style>
    ...
    /* הזרקת העיצוב לכל מסגרת באפליקציה */
...
def create_styled_card(title, icon=""):
    """פונקציה גנרית ליצירת מלבן מעוצב עם כותרת"""
    card = st.container(border=True)
    card.markdown(f"### {icon} {title}")
    return card
...
# --- 4. Header & Profile ---
st.markdown(f"<div style='text-align:center; margin-bottom:15px;'><h2 style='font-weight:800;'><span class='text-gradient'>Dashboard AI</span></h2></div>", unsafe_allow_html=True)
...
with col_main:
    # מלבן פרויקטים - שימוש בפונקציה הגנרית
    with create_styled_card("פרויקטים ומרכיבים", "📁"):
    ...
    # מלבן AI Oracle - שימוש בפונקציה הגנרית
    with create_styled_card("AI Oracle", "✨"):
...
with col_side:
    # מלבן פגישות - שימוש בפונקציה הגנרית
    with create_styled_card("פגישות היום", "📅"):
    ...
    # מלבן תזכורות - שימוש בפונקציה הגנרית
    with create_styled_card("תזכורות", "🔔"):
