...
# --- 2. CSS פשוט ותקני (ללא כפייה אגרסיבית) ---
st.markdown("""
<style>
    ...
    /* המסגרת המעוצבת לאזורים - יצירת מכולה עצמאית */
    .custom-container {
        background-color: white;
        border: 2px solid #4facfe; /* צבע תכלת ישיר */
        border-radius: 15px;
        padding: 20px;
        margin-bottom: 20px;
...
# --- 4. תצוגה ---
st.markdown('<h1 class="header-style">Dashboard AI</h1>', unsafe_allow_html=True)
...
# גוף הדשבורד עם עטיפת ה-Custom Container
st.markdown("<br>", unsafe_allow_html=True)
col_right, col_left = st.columns([2, 1.2])

with col_right:
    # פרויקטים
    st.markdown('<div class="custom-container"><h3>📁 פרויקטים ומרכיבים</h3>', unsafe_allow_html=True)
    ...
    # AI Oracle
    st.markdown('<div class="custom-container"><h3>✨ AI Oracle</h3>', unsafe_allow_html=True)
...
with col_left:
    # פגישות
    st.markdown('<div class="custom-container"><h3>📅 פגישות היום</h3>', unsafe_allow_html=True)
    ...
    # תזכורות
    st.markdown('<div class="custom-container"><h3>🔔 תזכורות</h3>', unsafe_allow_html=True)
