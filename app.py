...
# --- 1. הזרקת CSS אגרסיבית (מכריחה את העיצוב על כל המכולות) ---
...
<style>
    ...
    /* תפיסת כל קונטיינר עם border ומתיחת העיצוב על כולו */
    ...
    /* יישור לימין לכל הרכיבים - פתרון גלובלי */
...
def styled_card(title, icon=""):
    """פונקציה גנרית ליצירת מלבן מעוצב הכולל הכל"""
