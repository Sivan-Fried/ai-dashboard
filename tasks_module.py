...
def show_tasks_page(project_name=None):
    ...
    .t-badge { display:inline-block; padding:3px 10px; border-radius:20px; font-size:0.72rem; font-weight:700; }
    .t-badge-done    { background:#ecfdf5; color:#10b981; }
    .t-badge-active  { background:#eff6ff; color:#3b82f6; }
    .t-badge-waiting { background:#f8fafc; color:#94a3b8; }
    .t-badge-late    { background:#fef2f2; color:#ef4444; }
    </style>
    ...
    with st.container(border=True):
        ...
        <div class="task-header">
            <span style="font-size:0.75rem;font-weight:700;color:#94a3b8;">משימה</span>
        ...
        if df_view.empty:
            ...
            badge_map = {
                "הושלם":  "t-badge-done",
                "בביצוע": "t-badge-active",
                "ממתין":  "t-badge-waiting",
                "באיחור": "t-badge-late",
            }
            for _, row in df_view.iterrows():
                ...
                badge_cls = badge_map.get(s, "t-badge-waiting")
                ...
                <div class="task-row">
                    ...
                    <span><span class="t-badge {badge_cls}">{s}</span></span>
                    <span style="font-size:0.82rem;color:#3f3f46;">{resp}</span>
                    <span style="font-size:0.78rem;color:#71717a;">{start_str}</span>
                    <span style="font-size:0.78rem;color:{due_color};">{due_str}</span>
                </div>
                """, unsafe_allow_html=True)
